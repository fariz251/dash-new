...
-- Catatan: partner_id & partner_key TIDAK disimpan di sini, cukup di Environment Variables
-- Vercel (SHOPEE_PARTNER_ID, SHOPEE_PARTNER_KEY) karena nilainya sama utk semua toko & sensitif.
